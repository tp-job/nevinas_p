...
const ProjectCard: FC<ProjectCardProps> = ({
  ...
  return (
    <div className="neu-card group flex flex-col bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1">
      {/* Image / Hero section */}
      <div
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <i
            className={`${icon} text-[120px] text-white/[0.07] transition-transform duration-500 group-hover:scale-110 group-hover:rotate-6`}
          ></i>
        </div>
      ...
      <div className="flex flex-col grow p-6">
        ...
        <div className="flex items-center gap-3 pt-4 border-t border-light-border dark:border-dark-border mt-auto">
          ...
          <a
            ...
            className="neu-btn flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-medium bg-light-surface-2 dark:bg-dark-surface text-light-text-secondary dark:text-dark-text-secondary hover:bg-light-text hover:text-light-bg dark:hover:bg-dark-text dark:hover:text-dark-bg transition-all duration-300"
          >
