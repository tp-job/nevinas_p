...
const GatewayTimeout: FC = () => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-light-bg dark:bg-dark-bg overflow-hidden">
      ...
      <div
        className="absolute bottom-1/3 left-1/3 w-80 h-80 bg-global-red/10 rounded-full blur-[120px] animate-pulse"
      ...
      <div className="relative z-10 text-center px-6 max-w-2xl mx-auto">
        ...
        <p className="text-light-text-secondary dark:text-dark-text-secondary mb-2 max-w-md mx-auto">
          The server took too long to respond. This might be due to network
        ...
        <div className="my-6">
          ...
          >
            <circle
              ...
              cy="100"
              r="55"
              className="stroke-global-yellow"
              strokeWidth="3"
              fill="none"
            />
            <circle
              ...
              cy="100"
              r="48"
              className="stroke-global-yellow/30"
              strokeWidth="1.5"
              strokeDasharray="6 4"
            />
            <line
            ...
            <line
              ...
              x2="125"
              y2="100"
              className="stroke-global-yellow/60"
              strokeWidth="2"
              strokeLinecap="round"
            />
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <button
            ...
            className="px-8 py-3 rounded-full bg-gradient-to-r from-global-yellow to-global-red text-white font-medium flex items-center gap-2 hover:opacity-90 transition-opacity shadow-lg shadow-global-yellow/20"
          >
        ...
        <p className="text-xs text-light-text-secondary/50 dark:text-dark-text-secondary/50">
          Still having issues?{" "}
          <Link to="/#contact" className="text-global-yellow hover:underline">
            Contact support
          </Link>
        </p>
      </div>
