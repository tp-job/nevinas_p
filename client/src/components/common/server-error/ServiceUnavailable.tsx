...
const ServiceUnavailable: FC = () => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-light-bg dark:bg-dark-bg overflow-hidden">
      ...
      <div
        className="absolute bottom-1/4 right-1/3 w-80 h-80 bg-global-purple/15 rounded-full blur-[120px] animate-pulse"
      ...
      <div className="relative z-10 text-center px-6 max-w-2xl mx-auto">
        ...
        <div className="relative mb-6">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div
              className="w-36 h-36 border-2 border-dashed border-global-blue/30 dark:border-global-blue/20 rounded-full animate-spin"
        ...
        <p className="text-light-text-secondary dark:text-dark-text-secondary mb-2 max-w-md mx-auto">
          Our service is temporarily unavailable due to maintenance or high
          traffic. We'll be back soon!
        </p>
        ...
        <div className="my-6">
          <svg
            className="w-28 h-28 mx-auto opacity-50 dark:opacity-30"
            viewBox="0 0 200 200"
            fill="none"
          ...
          >
            ...
            <circle
              ...
              cy="100"
              r="65"
              className="stroke-global-blue/30"
              strokeWidth="1.5"
              strokeDasharray="6 4"
            />
            <circle
              ...
              cy="115"
              r="14"
              className="stroke-global-purple"
              strokeWidth="2.5"
              fill="none"
            />
            ...
            <rect
              ...
              height="8"
              rx="1"
              className="fill-global-purple/60"
            />
            <rect
              x="117"
              y="128"
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <button
            ...
            className="px-8 py-3 rounded-full bg-gradient-to-r from-global-blue to-global-purple text-white font-medium flex items-center gap-2 hover:opacity-90 transition-opacity shadow-lg shadow-global-blue/20"
          >
          ...
          <Link
            to="/"
            className="px-8 py-3 rounded-full border border-light-border dark:border-dark-border text-light-text dark:text-dark-text font-medium flex items-center gap-2 hover:bg-light-surface dark:hover:bg-dark-surface transition-colors"
          >
