        ...
        <div className="flex-1">
          ...
          <ul className="grid max-w-2xl grid-cols-1 gap-6 sm:grid-cols-3">
            {DataAbout.map((items) => (
              <li
                key={items.id}
                className="border-[.5px] border-light-border rounded-xl p-6 cursor-pointer hover:bg-light-surface-2 hover:-translate-y-1 duration-500 hover:shadow-black dark:border-dark-text dark:hover:shadow-dark-text dark:hover:bg-dark-surface"
              >
                <i
                  className={`${items.icon} text-5xl text-light-text dark:text-dark-text`}
                ></i>
                <h3 className="my-4 font-semibold text-light-text dark:text-dark-text">
                  {items.title}
                </h3>
          ...
          <h4 className="my-6 text-light-text-secondary dark:text-dark-text">
            Tools i user
          </h4>
          <ul className="flex items-center gap-3 sm:gap-5">
            {DataTools.map((items) => (
              <li
                key={items.id}
                className="flex items-center justify-center w-12 duration-500 border border-light-border rounded-lg cursor-pointer sm:w-14 aspect-square hover:-translate-y-1 dark:border-dark-text"
              >
                <i
