  ...
  return (
    <div id="services" className="w-full px-[8%] py-20 scroll-mt-20 flex flex-col items-center">
      <div className="mb-16 flex flex-col items-center text-center">
        {/* Eyebrow — label style */}
        <p className="text-xs font-medium tracking-widest uppercase mb-2 text-[var(--color-text-secondary)]">
          Specializations
        </p>

        {/* Main title — headline-lg style (normal weight) */}
        <h2 className="text-4xl sm:text-5xl font-normal tracking-tight text-[var(--color-text-primary)] mb-1">
          My Services
        </h2>

        {/* Subtitle — jp-caption style (zen font, light weight) */}
        <h3 className="font-zen text-xl font-light tracking-wide text-[var(--color-text-secondary)]">
          Professional Expertise
        </h3>
        
        <div className="w-12 h-1 bg-gradient-to-r from-[#465078] to-[#878CB4] rounded-full mt-6 opacity-60" />
      </div>
      ...
      <div className="grid w-full max-w-5xl grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-4">
        ...
        <div className="glass-premium md:col-span-1 md:row-span-2 p-8 flex flex-col justify-between group transition-all duration-300 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="inline-flex p-3 rounded-xl mb-6 bg-gradient-to-br from-[#465078] to-[#3E60C1] shadow-[0_6px_18px_rgba(70,80,120,0.28)] group-hover:scale-110 transition-transform duration-500">
            ...
            <h3 className="text-2xl font-normal text-[var(--color-text-primary)] mb-4">{DataServices[0].title}</h3>
            <p className="text-sm leading-relaxed text-[var(--color-text-secondary)] mb-6">
              {DataServices[0].detail}
            </p>
            <ul className="space-y-2 text-xs text-[var(--color-text-secondary)] opacity-70">
          ...
          <a href="#" className="relative z-10 inline-flex items-center text-xs font-medium text-matte-azure hover:opacity-80 transition-all mt-8 uppercase tracking-widest">
            VIEW DETAILS 
        ...
        <div className="glass-premium md:col-span-2 p-8 flex flex-col justify-center group transition-all duration-300 relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-start gap-6">
            <div className="inline-flex p-3 rounded-xl bg-gradient-to-br from-[#465078] to-[#3E60C1] shadow-[0_6px_18px_rgba(70,80,120,0.28)] shrink-0 group-hover:scale-110 transition-transform duration-500">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h3 className="text-xl font-normal text-[var(--color-text-primary)] mb-2">{DataServices[1].title}</h3>
        ...
        <div className="glass-premium p-6 group transition-all duration-300">
          <div className="inline-flex p-2.5 rounded-lg mb-4 bg-gradient-to-br from-[#465078] to-[#3E60C1] shadow-[0_6px_18px_rgba(70,80,120,0.28)] group-hover:scale-110 transition-transform duration-500">
          ...
          <h3 className="text-lg font-normal text-[var(--color-text-primary)] mb-2">{DataServices[2].title}</h3>
        ...
        <div className="glass-premium p-6 group transition-all duration-300">
          ...
          <h3 className="text-lg font-normal text-[var(--color-text-primary)] mb-2">{DataServices[3].title}</h3>
          <p className="text-xs leading-normal text-[var(--color-text-secondary)]">
