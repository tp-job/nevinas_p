            ...
            <>
              ...
              >
                ...
                <motion.div
                  ...
                  /* Size of the comet core */ style={{
                    background:
                      "radial-gradient(circle, rgba(168,85,247,0.8) 0%, rgba(99,102,241,0.5) 40%, rgba(34,211,238,0) 70%)",
                    /* Intense, layered glow effect for the comet */ boxShadow: ` 0 0 15px 4px rgba(168, 85, 247, 0.6), 0 0 25px 8px rgba(99, 102, 241, 0.4), 0 0 40px 15px rgba(34, 211, 238, 0.2)`,
                  }}
