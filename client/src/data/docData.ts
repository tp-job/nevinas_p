...
export const designSystem = {
  mainTheme: [
    ...
    {
      name: "Velvet Indigo",
      variable: "--color-velvet-indigo",
      hex: "#50409A",
    },
    {
      name: "Velvet Orchid",
      variable: "--color-velvet-orchid",
      hex: "#964EC2",
    },
    {
      name: "Velvet Flamingo",
      variable: "--color-velvet-flamingo",
      hex: "#FF7BBF",
    },
  ],
  lightMode: [
