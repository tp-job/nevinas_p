...
const Gallery: FC = () => {
    ...
    useEffect(() => {
        ...
        if (selectedIndex !== null && filteredGallery.length > 0 && selectedIndex < filteredGallery.length) {
    ...
    return (
        <div className="w-full">
            ...
            <div className="mb-8">
                <div className="relative h-20 flex items-center overflow-hidden border-t border-b border-light-border dark:border-dark-border">
                    ...
                    <div className="absolute left-0 top-0 bottom-0 px-8 bg-background-light dark:bg-background-dark z-50 flex items-center gap-4 border-r border-light-border dark:border-dark-border">
                        ...
                        <span className="text-sm font-black text-light-text-primary dark:text-dark-text-primary tracking-wider uppercase">CATEGORY</span>
                    </div>
            ...
            {isLightboxOpen && filteredGallery.length > 0 && selectedIndex !== null && (
